\documentclass[11pt,a4paper,sans,twoside]{moderncv}
...
% personal data
\name{Tobia}{Marcucci}
\address{Assistant Professor at the University of California, Santa Barbara and Amazon Scholar}{}{}
\email{marcucci@ucsb.edu}
\extrainfo{\emailsymbol\emaillink{tobmar@amazon.com}}
\begin{document}
...
\textit{Affiliate of the Department of Mechanical Engineering} \\
\textit{Affiliate of the Center for Control, Dynamical Systems, and Computation}

\item \textbf{Amazon} \hfill 7/2026 to present \\
\textit{Amazon Scholar} 
...
\textit{Thesis:} \href{https://dspace.mit.edu/handle/1721.1/156598}{\color{cyan}Graphs of Convex Sets with Applications to Optimal Control and Motion Planning} \\
Recipient of the \href{https://www.eecs.mit.edu/eecs-2025-awards/}{\color{cyan}MIT EECS George M. Sprowls Ph.D. Thesis Award in AI and Decision Making}
...
\item \textbf{Mixed Discrete and Continuous Planning using Shortest Walks in Graphs of Convex} \hfill 2026 \\ \textbf{Sets} \\
\textit{Savva Morozov, Tobia Marcucci, Bernhard Paus Graesdal, Alexandre Amice, Pablo Parrilo, and Russ Tedrake} \\
World Symposium on the Algorithmic Foundations of Robotics (WAFR)
...
\item \textbf{An Efficient Algorithm for Minimum-Pressure Growth Planning of Vine Robots} \hfill 2026 \\
\textit{Andres C. Torres, Tobia Marcucci, and Elliot W. Hawkes} \\
Under review in IEEE International Conference on Robotics and Automation (ICRA) \\
arXiv:2609.18070

\item \textbf{Biconvex Optimization for Smooth Minimum-Time Trajectories around Convex Obstacles} \hfill 2026 \\
\textit{Peter Werner, Tobia Marcucci, and Daniela Rus} \\
Under review in IEEE Transactions on Robotics (TRO) \\
arXiv:2608.02834
	
\item \textbf{A Unified and Scalable Method for Optimization over Graphs of Convex Sets} \hfill 2025 \\
\textit{Tobia Marcucci} \\
Under review in Mathematical Programming Computation \\
arXiv:2510.20184
...
\begin{itemize}
\item \textit{Optimization and Learning for Robotics and Control} \hfill Spring 2026 \\
Graduate course at the University of California, Santa Barbara (ECE 594T)
\item \textit{Introduction to Robotics: Planning and Kinematics} \hfill Spring 2025, Fall 2025 \\
...
\item IEEE International Conference on Robotics and Automation (\href{https://sites.google.com/robotics.utias.utoronto.ca/icra26-frontiers-optimization/}{\color{cyan}Frontiers of Optimization for} \hfill 6/2026 \\
\href{https://sites.google.com/robotics.utias.utoronto.ca/icra26-frontiers-optimization/}{\color{cyan}Robotics Workshop}) [\href{https://www.youtube.com/watch?v=R9DX7Qxf01c&t=806s}{\color{orange}recording}]

\item
\href{https://sites.google.com/site/ucsbpdeappliedmathseminar/spring-2026}{\color{cyan}University of California, Santa Barbara (Applied Math Seminar)} 
 \hfill 05/2026
	
\item
\href{https://www.cvxpy.org/workshop/2026/}{\color{cyan}CVXPY Workshop} [\href{https://www.youtube.com/watch?v=vnfMD4t3lkU}{\color{orange}recording}]  \hfill 02/2026

\item
\href{https://zardini.mit.edu/autonomytalks/}{\color{cyan}Autonomy Talks} [\href{https://www.youtube.com/watch?v=N-qSSUX83Rk}{\color{orange}recording}]  \hfill 11/2025

\item
University of California, Santa Barbara (ECE Seminar) \hfill 11/2025
...
\begin{itemize}
\item 
\href{https://www.eecs.mit.edu/eecs-2025-awards/}{\color{cyan}MIT EECS George M. Sprowls Ph.D. Thesis Award in Artificial Intelligence and Decision Making} \hfill 2025
...
%\begin{itemize}
%
%\item Grade of A$+$ in more than half of the classes taken in the Ph.D. at MIT
%
%\item Grade of A$+$ in all the classes taken for the minor in mathematics in the Ph.D. at MIT
%
