...
- Time and location: please respond to the "Initial survey" by Wednesday April 2nd, so that we can find times that work for everyone.
...
Therefore, proficiency in Python is funadamental for anyone pursuing a career in robotics.
...
- Final between June 7 and 13 (precise time and location to be decided)
