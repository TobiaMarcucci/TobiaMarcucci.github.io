...
The lectures follow approximately the textbook.
After every lecture, I will write below the sections of the textbook covered during the lecture.
Note that the lectures do not follow the textbook exactly, we might cover additional material as well as skip some material.
